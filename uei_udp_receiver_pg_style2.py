...
STYLE_BG = "#eef2f7"
STYLE_PANEL = "#ffffff"
STYLE_CARD_BORDER = "#e2e8f0"
STYLE_PILL_BG = "#f1f5f9"
STYLE_GRID_ALPHA = 0.2
STYLE_ACCENT = "#2563eb"
STYLE_ACCENT_SOFT = "#dbeafe"
STYLE_TEXT = "#0f172a"
STYLE_TEXT_MUTED = "#64748b"
# ===========================================
...
class RealTimePlotterPg(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        slot_btn_style = (
            ...
            " padding: 4px 8px;"
            f" color: {STYLE_TEXT_MUTED};"
            "}"
            "QPushButton:hover {"
            f" color: {STYLE_TEXT};"
            "}"
            "QPushButton:checked {"
            f" color: {STYLE_ACCENT};"
            f" border-bottom: 2px solid {STYLE_ACCENT};"
            "}"
        )
        ...
        time_btn_style = (
            ...
            f" border: 1px solid {STYLE_CARD_BORDER};"
            " border-radius: 12px;"
            " padding: 3px 10px;"
            f" color: {STYLE_TEXT_MUTED};"
            "}"
    ...
    def _rebuild_plots_for_slot(self):
        ...
        for idx, stream_idx in enumerate(stream_idxs):
            ...
            ch_label.setStyleSheet(
                f"color: {STYLE_TEXT_MUTED};"
                f" background-color: {STYLE_PILL_BG};"
                " border-radius: 8px;"
                " padding: 2px 8px;"
            )
